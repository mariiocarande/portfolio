  ...
  return (
    <div ref={itemRef} className="timeline-item relative">
      ...
      <div className="absolute left-[7px] md:left-1/2 md:transform md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-zinc-700">
        {/* Dot */}
        <div className="absolute top-[24px] left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-white"></div>
        {/* Hide the line after the last item */}
        {isLast && <div className="absolute top-[24px] bottom-0 w-full bg-black"></div>}
      </div>
      ...
      >
        ...
        <div className={`pl-10 md:pl-0 md:text-right ${index % 2 === 0 ? "md:order-1" : "md:order-2"}`}>
